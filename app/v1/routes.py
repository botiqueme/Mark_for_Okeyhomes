...
def jsonify_return_success(status, status_code, data):
    return jsonify({
        "status": status,
        "code": status_code,
        "data": data
