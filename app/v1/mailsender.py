...
def send_email(msg):
    ...
    user = "botiquemeservices@gmail.com"
    subject = "New Appointment from MarkSalesBot"
    sender = user
    recipients = ["mik.quattromini@gmail.com", "g.accidia@gmail.com", "sarahlasaracina19@gmail.com"]
